...
// Template.registerHelper("isRestaurantView", function(){
//     return UserSession.get(Maestro.UserSessionConstants.ORDERS_VIEW_TYPE)=="RESTAURANT";
// });

// Template.registerHelper("formatOrderDateAndTime", function(orderDate){
...
// Template.registerHelper("formatOrderNumber", function(dailyOrderNumber){
//     if (dailyOrderNumber){
